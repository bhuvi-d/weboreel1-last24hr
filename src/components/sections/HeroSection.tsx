    ...
    >
      ...
      >
        <motion.div 
          ...
          className="text-xs md:text-sm uppercase tracking-[0.6em] text-primary mb-8 font-black flex items-center justify-center gap-4"
        >
        ...
        <motion.h1 
          ...
          className="text-6xl md:text-[12rem] font-display font-black tracking-tighter mb-12 text-glow leading-none select-none"
        >
          {formatted}
        </motion.h1>
        ...
        <motion.p 
          ...
          className="text-lg md:text-3xl font-light text-white/40 max-w-3xl mx-auto leading-relaxed italic"
        >
      ...
      <motion.div
        ...
        className="absolute bottom-20 left-1/2 -translate-x-1/2 flex flex-col items-center gap-10 z-[100]"
      >
        <div className="flex flex-col items-center gap-4">
          <motion.span 
            animate={{ scale: [1, 1.02, 1], opacity: [0.7, 1, 0.7] }}
            transition={{ repeat: Infinity, duration: 4 }}
            className="text-primary font-display font-black text-2xl md:text-5xl uppercase tracking-widest text-glow-red"
          >
        ...
        <div className="flex flex-col items-center gap-4 opacity-40 hover:opacity-100 transition-opacity">
          <span className="text-white font-mono text-xs uppercase tracking-[1.5em] ml-[1.5em]">
            Keep scrolling
          </span>
          <motion.div
            animate={{ y: [0, 8, 0] }}
